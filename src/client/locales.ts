...
export type BashPlusLocaleKey =
  ...
  | 'groupPresets'
  | 'presetNoteBroken' | 'presetNoteUnrecognized'
  ...
  | 'presetActionReset' | 'presetActionResetHint' | 'presetActionWorking'
  | 'presetPendingReset' | 'presetPendingInstall' | 'presetPendingRows'
  | 'presetConfirmReset' | 'presetConfirmInstall' | 'presetConfirmYes' | 'presetConfirmNo'
  | 'presetResultDone' | 'presetResultRows' | 'presetResultNoChange' | 'presetResultFailed'
  | 'presetResultResetDone' | 'presetResultResetNoChange'
  | 'presetResultBackup' | 'presetFailUnknown'
...
editBlockAutoGenerated: '阻止修改自动生成文件',
  ...
  // ---- 全局 tab · 预设分组 ----
  groupPresets: '预设',
  presetNoteBroken: '读取失败：{reason}',
  presetNoteUnrecognized: '无法识别内容，未做任何改动。',
  // 两个选择器
  presetPickPreset: '预设',
  ...
  presetActionUpdateHint: '只禁用这 {count} 个工具行（{rows}），其他内容保持不动。',
  presetActionUpdateNothing: '当前没有需要更新的工具行。',
  presetActionReset: '重置为对比模板',
  presetActionResetHint: '用所选模板「{template}」整份覆盖这份预设。原文件会先备份，本地改动会丢失。',
  presetActionWorking: '处理中…',
  presetPendingReset: '将用所选模板整份覆盖这份预设，本地改动会被覆盖。',
  presetPendingInstall: '将写入这份预设：它当前尚未安装。',
  presetPendingRows: '工具行将调整这 {count} 处：{rows}',
  presetConfirmReset: '用模板「{template}」整份覆盖会丢掉本地改动（原文件会先备份一份）。确认重置？',
  presetConfirmInstall: '将从模板「{template}」写入这份预设；当前没有会被覆盖的内容。',
  presetConfirmYes: '确认重置',
  presetConfirmNo: '取消',
  presetResultDone: '已调整 {count} 处。',
  presetResultRows: '涉及：{rows}',
  presetResultNoChange: '没有需要改动的行。',
  presetResultResetDone: '已重置为所选模板。',
  presetResultResetNoChange: '已经与所选模板一致，没有改动。',
  presetResultFailed: '操作失败：{reason}',
  presetResultBackup: '原文件已备份。',
...
editBlockAutoGenerated: 'Block editing auto-generated files',
  ...
  presetNoteBroken: 'Could not be read: {reason}',
  presetNoteUnrecognized: 'Content not recognized; nothing was changed.',
  ...
  presetToolError: 'This preset cannot be read',
  ...
  presetActionUpdateHint: 'Disables only these {count} tool rows ({rows}); everything else stays as it is.',
  presetActionUpdateNothing: 'No tool rows need updating.',
  presetActionReset: 'Reset to the compared template',
  presetActionResetHint: 'Overwrites this preset with the selected template "{template}". The original is backed up first and local edits are lost.',
  presetActionWorking: 'Working…',
  presetPendingReset: 'The whole preset will be replaced with the selected template; local changes will be lost.',
  presetPendingInstall: 'This preset will be written: it is not installed yet.',
  presetPendingRows: 'Tool rows to adjust: {count} ({rows})',
  presetConfirmReset: 'Overwriting with template "{template}" discards local changes (the original file is backed up first). Reset?',
  presetConfirmInstall: 'This preset will be written from template "{template}"; nothing will be overwritten.',
  presetConfirmYes: 'Reset',
  ...
  presetResultResetDone: 'Reset to the selected template.',
  presetResultResetNoChange: 'Already matches the selected template; nothing changed.',
  presetResultFailed: 'Action failed: {reason}',
  presetResultBackup: 'The original file was backed up.',
