...
import { type BlockContextSource, findBlockContextLines } from "../../omp/utils/block-context.ts";
import { DEFAULT_FUZZY_THRESHOLD, EditMatchError, findMatch } from "./modes/replace";
import { adjustIndentation, normalizeToLF, stripBom } from "../../omp/edit/normalize.ts";
