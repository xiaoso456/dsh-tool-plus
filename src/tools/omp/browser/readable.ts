 ...
 */
/**
 * Readable-content extraction from raw HTML — the OMP browser tool's
 * `extractReadableFromHtml`, copied verbatim (only the import path of
 * `htmlToBasicMarkdown` is adapted to this repo's fused scrapers layout).
 */
