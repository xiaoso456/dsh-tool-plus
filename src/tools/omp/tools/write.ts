...
import { formatPathRelativeToCwd, isInternalUrlPath, pathTargetsSsh, peelWriteUrlSelector, probeLiteralPathExists, splitPathAndSel } from "../../omp/tools/path-utils.ts";
...
export class WriteTool implements AgentTool<typeof writeSchema, WriteToolDetails> {
	...
	async #resolveConflict(
		...
		this.session.editStore?.invalidate(absolutePath);
