...
import {
	...
	SNAPSHOT_MAX_BYTES,
} from "../../omp/edit/file-snapshot-store.ts";
import { normalizeToLF } from "../../omp/edit/normalize.ts";
import { isNotebookPath, readEditableNotebookText } from "../../omp/edit/notebook.ts";
import { InternalUrlRouter, resolveLocalUrlToFile, resolveLocalUrlToPath } from "../../omp/internal-urls/index.ts";
import { type ResolvedArtifactFile, resolveArtifactFile } from "../../read/adapter/internal-urls/artifact-protocol";
import { parseInternalUrl } from "../../omp/internal-urls/parse.ts";
import type { InternalUrl } from "../../omp/internal-urls/types.ts";
import readDescription from "../../omp/prompts/tools/read.md" with { type: "text" };
...
import { formatBytes, shortenPath } from "../../omp/tools/render-utils.ts";
import { REPORT_ISSUE_DEVICE_NAME, reportIssueDeviceUsage } from "../../omp/tools/report-tool-issue.ts";
...
export class ReadTool implements AgentTool<typeof readSchema, ReadToolDetails> {
	...
	/**
	 * Stream multiple non-contiguous ranges from a local file. Each range is
	 * streamed independently with its own line/byte budget. Out-of-bounds
