...
function isAutoGeneratedFileName(filePath: string): boolean {
  // Windows 路径用 `\` 分隔——同时按 `/` 和 `\` 取 basename（T17-1）。
...
export async function assertEditableFile(absolutePath: string, displayPath?: string, _activeSettings?: unknown): Promise<void> {
